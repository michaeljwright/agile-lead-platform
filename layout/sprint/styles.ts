...
export const WasteContainer = styled('div', {
  width: '100%',
  height: '100%',
  backgroundImage: 'url(/waste-snake.png)',
  backgroundRepeat: 'no-repeat',
  backgroundSize: 'cover',
  backgroundPosition: 'left'
})

export const WasteItem = styled('div', {
  width: '20%',
  padding: '8px',
  marginLeft: '8px',
  outline: 'none',
...
export const WasteItemClose = styled('div', {
  marginTop: '-13px',
  marginLeft: '95%'
})

export const WasteItemText = styled('div', {
  marginTop: '-8px'
})
