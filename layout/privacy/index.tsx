    ...
    <Styles.Container>
      ...
      <Styles.Main>
        <Styles.Section>
          ...
          <p>This privacy notice for AgileLead.co.uk (`<strong>we</strong>`, `<strong>us</strong>`, or `<strong>our</strong>`), describes how and why we might collect, store, use, and/or share (`<strong>process</strong>`) your information when you use our services (`<strong>Services</strong>`), such as when you:</p>
          <ul>
            <li>Visit our website at <a href="https://agilelead.co.uk">www.agilelead.co.uk</a>, or any website of ours that links to this privacy notice
            </li>
          </ul>
          <ul>
            <li>Engage with us in other related ways, including any sales, marketing, or events</li>
          </ul>
          <p><strong>Questions or concerns?&nbsp;</strong>Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at support@agilelead.co.uk.</p>
          ...
          <p><strong>How do we keep your information safe?</strong> We have organisational and technical processes and procedures in place to protect your personal information. However, no electronic transmission over the internet or information storage technology can be guaranteed to be 100% secure, so we cannot promise or guarantee that hackers, cybercriminals, or other unauthorised third parties will not be able to defeat our security and improperly collect, access, steal, or modify your information. Learn more about&nbsp;<a href="#infosafe">how we keep your information safe</a>.</p>
          ...
          <p><a href="#uslaws">13. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a></p>
          ...
          <p><strong>7. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</strong></p>
          ...
          <p><strong>13. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</strong></p>
          ...
          <p>To submit a request to exercise these rights described above, please email support@agilelead.co.uk.</p>
          <p>If we decline to take action regarding your request and you wish to appeal our decision, please email us at support@agilelead.co.uk. Within forty-five (45) days of receipt of an appeal, we will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions.</p>
          ...
          <p>To submit a request to exercise these rights described above, please email support@agilelead.co.uk.</p>
          <p>If we decline to take action regarding your request and you wish to appeal our decision, please email us at support@agilelead.co.uk. Within sixty (60) days of receipt of an appeal, we will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions.</p>
          ...
          <p>You may contact us by email at support@agilelead.co.uk.</p>
          ...
          <p><strong>14. DO WE MAKE UPDATES TO THIS NOTICE?</strong></p>
          ...
          <p><strong>15. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</strong></p>
          <p>If you have questions or comments about this notice, you may email us at support@agilelead.co.uk.</p>
          <p>If you are a resident in the United Kingdom, we are the `data controller` of your personal information. We have appointed Mike Wright to be our representative in the UK. You can contact them directly regarding our processing of your information, by email at support@agilelead.co.uk.</p>
          <p><strong>16. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</strong></p>
          <p>Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please email at support@agilelead.co.uk.</p>
        </Styles.Section>
